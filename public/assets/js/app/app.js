  ...
  /*---------------------------------------*/
      ...
      $scope.updateModal=function(id ){
        ...
        $scope.task_assign= $('#to-do-assign-'+parseInt(id)).val();
         ...
         $('select[name=m_task_group]').find('option[value='+$scope.task_group+']').attr('selected', 'selected');
         $('select[name=m_task_group]').trigger('change');

         $('select[name=m_task_assign]').find('option[value='+$scope.task_assign+']').attr('selected', 'selected');
         $('select[name=m_task_assign]').trigger('change');
